...
import 'package:blood_donation/view/admin/screens/pagehome/doner_registration_page/donor_registration.dart';
      ...
      body:SingleChildScrollView(
        child: Column(
         ...
         const   SizedBox(height: 30,),
          ListTile(
           ...
           subtitle:const  Text("Donors must be in good health on the day of donation.Individuals with certain medical conditions or taking specific medications may be deferred from donating."),
         ), ListTile(
           title: Text("Travel History:",style:Colours().tileStyle()),
           subtitle:const  Text("Donors may be deferred based on recent travel history especially to regions with a high prevalence of infectious diseases"),
         ),  ListTile(
        ...
        ElevatedButton(
          ...
          onPressed:checkedValue?(){
             Navigator.push(context, MaterialPageRoute(builder: (context)=>DonorRegistrationHome()));
          }:null, child: const Text("Next",style: TextStyle(color: Colours.white,fontWeight: FontWeight.w500),),
        ),
